...
159. 你有写过自定义组件吗？
160. 你知道 style 加 scoped 属性的用途和原理吗？✔
161. 你有看过 vue 的源码吗？如果有那就说说看
162. 说下你对指令的理解？
163. 你有写过自定义指令吗？自定义指令的生命周期（钩子函数）有哪些？
164. v-show 和 v-if 有什么区别？使用场景分别是什么？✔
165. 说说你对 MVC、MVP、MVVM 模式的理解
166. 什么是虚拟 DOM？
167. 什么是双向绑定？原理是什么？
168. vue 和 react 有什么不同？使用场景是什么？
169. 说说 vue 的优缺点
170. 有使用过 vue 吗？说说你对 vue 的理解
171. vuex 相对于 bus 的区别和实现
172. keepalive 实现 ✔
173. 双向数据绑定实现，如何添加进 dep watcher
