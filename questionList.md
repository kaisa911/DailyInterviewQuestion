...
140. 为何官方推荐使用 axios 而不用 vue-resource？
141. 说说你对 vue 的 template 编译的理解？
142. v-on 可以绑定多个方法吗？✔
143. vue 常用的修饰符有哪些？列举并说明
144. 你认为 vue 的核心是什么？
145. 说说你对 vue 的 mixin 的理解，有什么应用场景？✔
146. 删除数组用 delete 和 Vue.delete 有什么区别？
147. 动态给 vue 的 data 添加一个新的属性时会发生什么？怎样解决？
148. 说说你使用 vue 过程中遇到的问题（坑）有哪些，你是怎么解决的？
149. 说说你对选项 el,template,render 的理解
150. vue 实例挂载的过程是什么？
151. v-if 和 v-for 的优先级是什么？如果这两个同时出现时，那应该怎么优化才能得到更好的性能？✔
152. 分别说说 vue 能监听到数组或对象变化的场景，还有哪些场景是监听不到的？无法监听时有什么解决方案？
153. 为什么 data 属性必须声明为返回一个初始数据对应的函数呢？✔
154. 怎么在 watch 监听开始之后立即被调用？
155. watch 怎么深度监听对象变化？✔
156. watch 和计算属性有什么区别？✔
157. vue 如何监听键盘事件？✔
158. v-for 循环中 key 有什么作用？✔
159. 怎么在 vue 中使用插件？
160. vue 在组件中引入插件的方法有哪些？
161. 组件和插件有什么区别？
162. 你有写过自定义组件吗？
163. 你知道 style 加 scoped 属性的用途和原理吗？✔
164. 你有看过 vue 的源码吗？如果有那就说说看
165. 你有写过自定义指令吗？自定义指令的生命周期（钩子函数）有哪些？
166. v-show 和 v-if 有什么区别？使用场景分别是什么？
167. 说说你对 MVC、MVP、MVVM 模式的理解
168. 说下你对指令的理解？
169. 什么是虚拟 DOM？
170. 什么是双向绑定？原理是什么？
171. vue 和 react 有什么不同？使用场景是什么？
172. 说说 vue 的优缺点
173. 有使用过 vue 吗？说说你对 vue 的理解
174. vuex 相对于 bus 的区别和实现
175. keepalive 实现 ✔
176. 双向数据绑定实现，如何添加进 dep watcher
